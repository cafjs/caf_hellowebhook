...
# AUTHOR:         
# DESCRIPTION:    Cloud Assistants application hellowebhook
# TO_BUILD:        cafjs mkImage . gcr.io/cafjs-k8/<user>-hellowebhook
# TO_RUN:         cafjs run --appImage gcr.io/cafjs-k8/<user>-hellowebhook hellowebhook
